 ...
 */
@Autonomous(name = "02_BlueBasket1BS3YS")
public class AutonBABask1BS3YSStates extends LinearOpMode {
...
///Drop Second Yellow Starts
        trajSequence = drive.trajectorySequenceBuilder(trajSequence.end())
                .splineToLinearHeading(new Pose2d(55, 54, Math.toRadians(-140)), Math.toRadians(90))
                .addDisplacementMarker(1, () -> {
...
//Consume Third Yellow Start
        ...
        trajSequence = drive.trajectorySequenceBuilder(trajSequence.end())
                ...
                .splineToLinearHeading(new Pose2d(56, 40, Math.toRadians(-95)), Math.toRadians(90))
                .build();
        drive.followTrajectorySequence(trajSequence);
        while (hSlider.isBusy()) {
            if (hSliderMinPose - hSlider.getCurrentPosition() < 1) {
...
//Consume Fourth Yellow Start
        ...
        trajSequence = drive.trajectorySequenceBuilder(trajSequence.end())
                ...
                .splineToLinearHeading(new Pose2d(61, 44, Math.toRadians(-75)), Math.toRadians(90))
                .build();
        drive.followTrajectorySequence(trajSequence);
        while (hSlider.isBusy()) {
            if (hSliderMinPose - hSlider.getCurrentPosition() < 1) {
...
//Parking Starts
        ...
        trajSequence = drive.trajectorySequenceBuilder(trajSequence.end())
                ...
                .splineToLinearHeading(new Pose2d(19,12,Math.toRadians(-10)),Math.toRadians(150))
