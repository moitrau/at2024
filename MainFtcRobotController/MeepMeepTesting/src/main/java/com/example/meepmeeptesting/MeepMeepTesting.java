    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(9, -64, Math.toRadians(-90)))
                        ...
                        .splineToLinearHeading(new Pose2d(45,-12,Math.toRadians(90)),Math.toRadians(-55))
                        .setReversed(true)
                        .lineToLinearHeading(new Pose2d(45,-56,Math.toRadians(90)))
                        .setReversed(false)
                        .splineToLinearHeading(new Pose2d(54,-12,Math.toRadians(90)),Math.toRadians(-55))
                        .setReversed(true)
                        .lineToLinearHeading(new Pose2d(54,-56,Math.toRadians(90)))
                        .setReversed(false)
                        .splineToLinearHeading(new Pose2d(64,-12,Math.toRadians(90)),Math.toRadians(-55))
                        .setReversed(true)
